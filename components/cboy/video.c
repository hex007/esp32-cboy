...
double toc() {
    ...
    return ((double) (toc_time.tv_usec - tic_time.tv_usec)) / 1000
        + (toc_time.tv_sec - tic_time.tv_sec) * 1000;
}
...
void vid_frame()
{
    ...
    // ili9341_write_frame(0, 0, 160, 144, pixmem);
}
