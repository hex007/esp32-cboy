...
extern unsigned char* getromdata();

void cart_init_cartrom( char* cartromName )
{

  cart.cartromsize = 32768; // For Tetris world :)
  ...
  // Read the cartrom.
  memcpy(cart.cartrom, getromdata(), cart.cartromsize);
